...
do_install_append_broadband_dunfell () {
	rm -rf ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43430-sdio.gx,3-model-b.txt
	rm -rf ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43455-sdio.gx,3-model-b-plus.txt
    rm -rf ${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43455-sdio.gx,4-model-b.txt
